    ...
    <div class="back-image">
      <main class="contenedor bomba" >
       ...
       if($perfilId == 0 || $perfilId == 1){ 
        ...
        <a href="https://www.netflix.com/br/title/80119234"><button role="button" class="boton"><i class="fas fa-info-circle"></i>Mais Informação</button></a>');
      }else{
        echo('<a href="https://youtu.be/yBiU39bUFlA"><button role="button" class="boton"><i class="fas fa-play"></i>Trailer</button></a>
        <a href="https://www.netflix.com/br/title/81444554"><button role="button" class="boton"><i class="fas fa-info-circle"></i>Mais Informação</button></a>');
